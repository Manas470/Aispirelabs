...
import AP from "../assets/Emblem_of_Andhra_Pradesh.webp";
import scaler from "../assets/scaler.webp";
import tiktok from "../assets/tiktok original.webp";

import UF from "../assets/UF.webp";
const LandingPage = () => {
  return (
    <div className="landing-page">
      ...
      <div className="core-team">
        <div className="flex flex-row justify-center items-center mt-10 p-8">
          <p className="text-4xl font-bold shadow-md">Core Team </p>
          <img src={AP} alt="Andhra Pradesh" className="w-[12%] h-1/4" />
          <img src={scaler} alt="Scaler" className="w-[10%] h-1/4" />
          <img src={tiktok} alt="Tiktok" className="w-[10%] h-1/4" />
          <img src={UF} alt="UF" className="w-1/6 h-1/4" />
        </div>
      </div>
